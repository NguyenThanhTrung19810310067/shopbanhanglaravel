...
<div class="product-details"><!--product-details-->
    <div class="col-sm-5">
        <div class="view-product">
            <img src="{{URL::to('public/product/'.$pro->product_image)}}" alt="" />
            <h3>ZOOM</h3>
        </div>
              ...
              <!-- Wrapper for slides -->
                <div class="carousel-inner">
                    <div class="item active">
                      <a href=""><img src="{{URL::to('public/product/'.$pro->product_image)}}" alt=""></a>
                      <a href=""><img src="{{URL::to('public/product/'.$pro->product_image)}}" alt=""></a>
                      <a href=""><img src="{{URL::to('public/product/'.$pro->product_image)}}" alt=""></a>
                    </div>
                    <div class="item">
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <p><b>Mô tả:</b> {{$pro->product_desc}}</p>
                    ...
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{URL::to('public/product/'.$lienquan->product_image)}}" alt="" />
