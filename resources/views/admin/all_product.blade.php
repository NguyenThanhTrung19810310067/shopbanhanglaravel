        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img src="public/product/{{$product->product_image}}" height="100" width="100"></td>
              ...
              <td>
                ...
                <a href="{{URL::to('/delete-product/'.$product->product_id)}}" onclick="return confirm('Are you sure to delete?')" class="active styling-edit" ui-toggle-class="">
